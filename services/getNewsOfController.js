...
export const executeGetPolicyNews = () => executeGetNewsType(paramsEn, ['policy', 'government', 'tax', 'elections', 'politics', 'political parties', 'corruption', 'human rights', 'freedom of speech', 'justice', 'foreign policy', 'diplomacy', 'international conflicts', 'international organizations', 'UN', 'NATO', 'EU', 'geopolitics'], 'Policy');
// GET IT NEWS IN ENGLISH
export const executeGetITNews = () => executeGetNewsType(paramsEn, ["IT", "technology", "computing", "software", "hardware", "internet", "AI", "artificial intelligence", "machine learning", "ML", "deep learning", "DL", "data science", "big data", "cloud computing", "cybersecurity", "blockchain", "cryptocurrency"], 'IT');